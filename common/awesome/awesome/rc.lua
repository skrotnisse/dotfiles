...
mymainmenu = awful.menu({ items = { 
   ...
   { "distribution", debian.menu.Debian_menu.Debian }
                                  }
                        })
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "Delete",    awful.tag.viewprev,
              {description = "view previous", group = "tag"}),
    awful.key({ modkey,           }, "Page_Down", awful.tag.viewnext,
              {description = "view next", group = "tag"}),
    awful.key({ modkey,           }, "End",       awful.tag.history.restore,
    ...
    awful.key({ modkey,           }, "Up",
        ...
        {description = "focus next in up direction", group = "client"}
    ),
    awful.key({ modkey,           }, "Down",
        function ()
            awful.client.focus.bydirection( "down" )
        end,
        {description = "focus next in down direction", group = "client"}
    ),
    awful.key({ modkey,           }, "Left",
        function ()
            awful.client.focus.bydirection( "left" )
        end,
        {description = "focus next in left direction", group = "client"}
    ),
    awful.key({ modkey,           }, "Right",
        function ()
            awful.client.focus.bydirection( "right" )
        end,
        {description = "focus next in right direction", group = "client"}
    ),
    ...
    awful.key({ modkey,           }, "F2", function () awful.spawn("wireshark") end,
              {description = "run wireshark", group = "launcher"}),
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "Tab",    function (c) c:kill()                         end,
